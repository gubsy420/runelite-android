...
tasks.register<JavaExec>("injectBad") {
    ...
    val targetJar = "data/runelite-1.12.27-injected-26504454311.147.jar"
    val outputJar = "data/runelite-1.12.27-injected-26504454311.147-bad.jar"
...
tasks.register<JavaExec>("inject") {
    ...
    val targetJar = (findProperty("targetJar") as? String)
        ?: "data/runelite-1.12.27-injected-26504454311.147.jar"
