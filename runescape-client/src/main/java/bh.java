...
public class bh {
	...
	int ag() {
		int var2 = this.az_fld[this.ak_fld] >> this.ag_fld & 1;
		this.ag_fld++;
		this.ak_fld = this.ak_fld + (this.ag_fld >> 3) * 961229397;
		this.ag_fld &= -1701918005;
		return var2;
	}
	...
	int ak(int var1, int var2) {
		...
		while (var1 >= 8 - this.ag_fld) {
			int var5 = 8 - this.ag_fld;
			int var6 = (1 << var5) - 1;
			var3 += (this.az_fld[this.ak_fld] >> this.ag_fld & var6) << var4;
			this.ag_fld = 0;
			this.ak_fld++;
			var4 += var5;
			var1 -= var5;
		...
		if (var1 > 0) {
			int var7 = (1 << var1) - 1;
			var3 += (this.az_fld[this.ak_fld] >> this.ag_fld & var7) << var4;
			this.ag_fld += 779848757 * var1;
		}
	...
	public static void vc(bh var0, byte[] var1, int var2) {
		if (var0 == null) {
			var0.getClass();
		}
	...
	int ah(int var1) {
		...
		while (var1 >= 8 - this.ag_fld) {
			int var4 = 8 - this.ag_fld;
			int var5 = (1 << var4) - 1;
			var2 += (this.az_fld[this.ak_fld] >> this.ag_fld & var5) << var3;
			this.ag_fld = 0;
			this.ak_fld++;
			var3 += var4;
			var1 -= var4;
		...
		if (var1 > 0) {
			int var6 = (1 << var1) - 1;
			var2 += (this.az_fld[this.ak_fld] >> this.ag_fld & var6) << var3;
			this.ag_fld += 779848757 * var1;
		}
	...
	public static int pe(bh var0) {
		int var1 = var0.az_fld[var0.ak_fld] >> var0.ag_fld & 1;
		var0.ag_fld++;
		var0.ak_fld = var0.ak_fld + (var0.ag_fld >> 3) * 961229397;
		var0.ag_fld &= -1701918005;
		return var1;
	}
	...
	static int ao(int var0, ba var1, boolean var2) {
		...
		if (1600 == var0) {
			...
			if (12 == var4.bx_fld) {
				li var25 = lu.ax(var4, -2038984526);
				if (null != var25) {
					bp.ai_fld[(ef.aq_fld += -211521517) * -836183525 - 1] = li.bh(var25, (byte)45).ah();
					return 1;
				}
			}
			...
			if (var0 == 1618) {
				...
				li var23 = lu.ax(var4, -1498262069);
				bp.ai_fld[(ef.aq_fld += -211521517) * -836183525 - 1] = null != var23 ? li.mb(var23, -394538818).ah() : "";
				return 1;
			} else if (1620 == var0) {
				...
				li var21 = lu.ax(var4, -842594304);
				bp.au_fld[(gz.ax_fld += -1684678759) * -776631127 - 1] = null != var21 ? li.ge(var21, -1079282144) : 0;
				return 1;
			} else if (1622 == var0) {
				li var20 = lu.ax(var4, -539610030);
				bp.au_fld[(gz.ax_fld += -1684678759) * -776631127 - 1] = var20 != null ? var20.cx() : 0;
				return 1;
			} else if (1623 == var0) {
				li var19 = lu.ax(var4, -696605918);
				bp.au_fld[(gz.ax_fld += -1684678759) * -776631127 - 1] = var19 != null ? var19.cs() : 0;
				return 1;
			} else if (1624 == var0) {
				li var18 = lu.ax(var4, -1506481867);
				bp.au_fld[(gz.ax_fld += -1684678759) * -776631127 - 1] = var18 != null && var18.bb() ? 1 : 0;
				return 1;
			} else if (1625 != var0) {
				if (var0 == 1626) {
					li var17 = lu.ax(var4, -2123873050);
					bp.ai_fld[(ef.aq_fld += -211521517) * -836183525 - 1] = var17 != null ? var17.ba().ak() : "";
					return 1;
				} else if (var0 == 1627) {
					li var16 = lu.ax(var4, -1087251015);
					int var6 = null != var16 ? var16.cc() : 0;
					int var7 = var16 != null ? li.em(var16, (byte)-29) : 0;
					...
					li var15 = lu.ax(var4, -1125385900);
					bp.au_fld[(gz.ax_fld += -1684678759) * -776631127 - 1] = null != var15 ? li.em(var15, (byte)33) : 0;
					return 1;
				} else if (1629 == var0) {
					li var14 = lu.ax(var4, -1761619998);
					bp.au_fld[(gz.ax_fld += -1684678759) * -776631127 - 1] = var14 != null ? var14.cn() : 0;
					return 1;
				} else if (1630 == var0) {
					li var13 = lu.ax(var4, -1029534996);
					bp.au_fld[(gz.ax_fld += -1684678759) * -776631127 - 1] = null != var13 ? var13.cp() : 0;
					return 1;
				} else if (var0 == 1631) {
					li var12 = lu.ax(var4, -819351958);
					bp.au_fld[(gz.ax_fld += -1684678759) * -776631127 - 1] = var12 != null ? li.uu(var12, (byte)121) : 0;
					return 1;
				} else if (var0 == 1632) {
					li var11 = lu.ax(var4, -2012092754);
					bp.au_fld[(gz.ax_fld += -1684678759) * -776631127 - 1] = var11 != null ? var11.cg() : 0;
					return 1;
				} else if (1633 == var0) {
					sc var10 = var4.bu(-1356446230);
					bp.au_fld[gz.ax_fld - 1] = null != var10 ? var10.az(bp.au_fld[gz.ax_fld - 1], 321331076) : 0;
					return 1;
				} else if (1634 == var0) {
	...
	int aw() {
		int var1 = this.az_fld[this.ak_fld * -1147705734] >> this.ag_fld & 1;
		this.ag_fld++;
		this.ak_fld = this.ak_fld + (this.ag_fld >> 3) * -1810998573;
		this.ag_fld = (this.ag_fld & 7) * 225574760;
		return var1;
	}
