...
public abstract class de implements Runnable {
	...
	public static void uq(de var0, URLConnection var1) {
		if (var0 == null) {
			var0.getClass();
		} else {
	...
	@ObfuscatedName("bt")
	@ObfuscatedSignature(
		descriptor = "(Lde;Ljava/net/URLConnection;Ldj;S)V"
	)
	public static void bt(de var0, URLConnection var1, dj var2, short var3) {
		if (var0 == null) {
			var0.getClass();
		}
		...
		label84: {
			label83: {
				try {
					...
					if (var14) {
						var2.av_fld = var0.ah(var1, (byte)89);
					}
				}

				var2.av_fld = var0.ah(var1, (byte)105);
				break label84;
			}

			var2.av_fld = var0.ah(var1, (byte)107);
		}
	...
	public static void vc(de var0, URLConnection var1, dj var2) {
		if (var0 == null) {
			var0.getClass();
		}
		...
		label77: {
			label76: {
				try {
					...
					if (var13) {
						var2.av_fld = var0.ah(var1, (byte)127);
					}
				}

				var2.av_fld = var0.ah(var1, (byte)94);
				break label77;
			}

			var2.av_fld = var0.ah(var1, (byte)78) * 2686926;
		}
	...
	public static void th(de var0, URLConnection var1, dj var2) {
		if (var0 == null) {
			var0.getClass();
		}
