...
public class au {
	...
	static int[] ak_fld = new int[]{256, 128, 86, 64};
	@ObfuscatedName("ay")
	@ObfuscatedSignature(
		descriptor = "[I"
	)
	...
	au(bh var1) {
		int var2 = var1.ak(16, -1101179467);
		if (var2 != 1) {
			throw new RuntimeException();
		} else {
			int var3 = var1.ak(5, 1020062180);
			int var4 = 0;
			this.ae_fld = new int[var3];

			for (int var5 = 0; var5 < var3; var5++) {
				int var6 = var1.ak(4, 1046294521);
				this.ae_fld[var5] = var6;
				if (var6 >= var4) {
					var4 = var6 + 1;
				}
			}

			this.ah_fld = new int[var4];
			this.aw_fld = new int[var4];
			this.ay_fld = new int[var4];
			this.as_fld = new int[var4][];

			for (int var10 = 0; var10 < var4; var10++) {
				this.ah_fld[var10] = var1.ak(3, -1170291754) + 1;
				int var12 = this.aw_fld[var10] = var1.ak(2, 791112506);
				if (var12 != 0) {
					this.ay_fld[var10] = var1.ak(8, -159131669);
				}

				var12 = 1 << var12;
				int[] var7 = new int[var12];
				this.as_fld[var10] = var7;

				for (int var8 = 0; var8 < var12; var8++) {
					var7[var8] = var1.ak(8, -700318614) - 1;
				}
			}

			this.av_fld = var1.ak(2, -1044674369) + 1;
			int var11 = var1.ak(4, -774464455);
			int var14 = 2;

			for (int var16 = 0; var16 < var3; var16++) {
				var14 += this.ah_fld[this.ae_fld[var16]];
			}

			this.az_fld = new int[var14];
			this.az_fld[0] = 0;
			this.az_fld[1] = 1 << var11;
			var14 = 2;

			for (int var17 = 0; var17 < var3; var17++) {
				int var18 = this.ae_fld[var17];

				for (int var9 = 0; var9 < this.ah_fld[var18]; var9++) {
					this.az_fld[var14++] = var1.ak(var11, -1135108991);
				}
			}
		}
	}
	...
	void an(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
