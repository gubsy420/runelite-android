...
public class gf implements WorldMapData {
	...
	public boolean bs(int var1, int var2) {
		int var3 = var1 / 64;
		int var4 = var2 / 64;
		if (var3 >= this.ay_fld.az_fld * 2115450829 && var3 <= -1291504879 * this.ay_fld.ak_fld) {
			if (var4 >= this.ay_fld.av_fld * -1683164347 && var4 <= -1936218911 * this.ay_fld.ag_fld) {
	...
	public int cn() {
		return this.ay_fld.ag_fld * -1936218911;
	}
	...
	public boolean av(int var1, int var2, int var3) {
		int var4 = var1 / 64;
		int var5 = var2 / 64;
		if (var4 >= this.ay_fld.az_fld * 2115450829 && var4 <= -1291504879 * this.ay_fld.ak_fld) {
			if (var5 >= this.ay_fld.av_fld * -1683164347 && var5 <= -1936218911 * this.ay_fld.ag_fld) {
	...
	@ObfuscatedName("pk")
	@ObfuscatedSignature(
		descriptor = "(Lgf;IIB)Lkj;"
	)
	public static kj pk(gf var0, int var1, int var2, byte var3) {
		if (var0 == null) {
	...
	@ObfuscatedName("fu")
	@ObfuscatedSignature(
		descriptor = "(Lgf;I)Lkj;"
	)
	public static kj fu(gf var0, int var1) {
		if (var0 == null) {
			var0.getClass();
		}
	...
	public int ao(int var1) {
		return this.aw_fld.az_fld * 1479124089;
	}
	...
	public static void at(ey var0, long var1) {
		if (var0 == null) {
			var0.getClass();
		}
	...
	public int an(int var1) {
		return 2115450829 * this.ay_fld.az_fld;
	}
	...
	public int aa(int var1) {
		return -1291504879 * this.ay_fld.ak_fld;
	}
	...
	public int ai(int var1) {
		return this.ay_fld.av_fld * -1683164347;
	}
	...
	public void ap(xi var1, int var2) {
		this.ak_fld = 1598688653 * var2;
		this.az_fld = xi.kc(var1, 1887061781);
		this.ag_fld = xi.kc(var1, -1350400504);
		this.aw_fld = new kj(var1.co());
		this.av_fld = var1.co();
		this.ae_fld = var1.co() * -2020234737;
		var1.cg();
		this.as_fld = var1.cg() == 1;
		this.ah_fld = var1.cg() * 1653916963;
		int var3 = var1.cg();
	...
	public int ce() {
		return this.ay_fld.ag_fld * -1248031143;
	}
	...
	public int cw() {
		return this.aw_fld.az_fld * 663776266;
	}
	...
	public static int zx(gf var0) {
		return -1291504879 * var0.ay_fld.ak_fld;
	}
	...
	public static boolean xh(gf var0, int var1, int var2) {
		if (var0 == null) {
			var0.getClass();
		}
		...
		if (var3 >= var0.ay_fld.az_fld * 2115450829 && var3 <= 1672199660 * var0.ay_fld.ak_fld) {
			if (var4 >= var0.ay_fld.av_fld * -1683164347 && var4 <= -1936218911 * var0.ay_fld.ag_fld) {
	...
	public gf() {
		this.av_fld = -1368898017;
		this.ae_fld = 1996488704;
		this.ah_fld = -1157694313;
		this.aw_fld = null;
		this.ay_fld = new hf();
		this.as_fld = false;
	}
	...
	public boolean bh(int var1, int var2) {
		...
		int var4 = var2 / 64;
		if (var3 >= this.ay_fld.az_fld * 2115450829 && var3 <= -1358262381 * this.ay_fld.ak_fld) {
			if (var4 >= this.ay_fld.av_fld * 676133355 && var4 <= -1848960034 * this.ay_fld.ag_fld) {
				Iterator var5 = this.ar_fld.iterator();
	...
	@ObfuscatedName("ms")
	@ObfuscatedSignature(
		descriptor = "(Lgf;I)Ljava/lang/String;"
	)
	public static String ms(gf var0, int var1) {
		if (var0 == null) {
			throw new NullPointerException();
		} else {
			return var0.az_fld;
	...
	public void ak(xi var1, int var2, byte var3) {
		this.ak_fld = var2;
		this.az_fld = xi.kc(var1, -480270614);
		this.ag_fld = xi.kc(var1, -73631933);
		this.aw_fld = new kj(var1.co());
		this.av_fld = var1.co();
		this.ae_fld = var1.co();
		var1.cg();
	...
	@ObfuscatedName("df")
	@ObfuscatedSignature(
		descriptor = "(Lgf;Lxi;)Lhj;"
	)
	public static hj df(gf var0, xi var1) {
		if (var0 == null) {
			var0.getClass();
		}
	...
	public boolean bz(int var1, int var2, int var3) {
		Iterator var4 = this.ar_fld.iterator();
	...
	public static int dg(gf var0, int var1) {
		if (var0 == null) {
			var0.getClass();
		}
	...
	public int ca() {
		return this.aw_fld.ak_fld * 1846813669;
	}
	...
	public static boolean mn(gf var0, int var1) {
		if (var0 == null) {
			var0.getClass();
		}
	...
	public static int ka(gf var0, int var1) {
		if (var0 == null) {
			throw new NullPointerException();
		} else {
			return var0.aw_fld.ak_fld * 1846813669;
		}
	}
	...
	public static void qi(gf var0, xi var1, int var2) {
		if (var0 == null) {
			var0.getClass();
		}

		var0.ak_fld = -263408965 * var2;
		var0.az_fld = xi.kc(var1, 1777688835);
		var0.ag_fld = xi.kc(var1, -1478947477);
		var0.aw_fld = new kj(var1.co());
		var0.av_fld = var1.co();
		var0.ae_fld = var1.co();
		var1.cg();
		var0.as_fld = var1.cg() == 1;
		var0.ah_fld = var1.cg() * -1654446049;
		int var3 = var1.cg();
