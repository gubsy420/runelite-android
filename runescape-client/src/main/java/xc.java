...
public class xc {
	...
	public static HashMap tn(xc var0, xy[] var1) throws EOFException {
		if (var0 == null) {
			var0.getClass();
		}
	...
	@ObfuscatedName("tq")
	@ObfuscatedSignature(
		descriptor = "(Lgu;Ljava/lang/Object;)Z"
	)
	public static boolean tq(gu var0, Object var1) {
		if (var0 == null) {
			var0.getClass();
		}

		return var1 instanceof gu ? var0.au((gu)var1) : false;
	}

	@ObfuscatedName("ak")
	@ObfuscatedSignature(
		descriptor = "([Lxy;I)Ljava/util/HashMap;"
	)
