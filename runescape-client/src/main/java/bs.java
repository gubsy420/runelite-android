...
public class bs {
	...
	void az(int var1, int var2) {
		if (var1 < var2) {
			...
			int var6 = this.av_fld[var1];
			boolean var7 = this.ae_fld[var1];

			for (int var8 = 1 + var1; var8 <= var2; var8++) {
				int var9 = this.az_fld[var8];
				if (var9 < var5) {
					this.az_fld[var4] = var9;
					this.av_fld[var4] = this.av_fld[var8];
	...
	void av(float[] var1, int var2) {
		...
		for (int var6 = 2; var6 < var3; var6++) {
			int var7 = au.qq(this.ak_fld, this.az_fld, var6);
			int var8 = this.ak_fld.ag(this.az_fld, var6);
			int var9 = this.ak_fld.al(this.az_fld[var7], this.av_fld[var7], this.az_fld[var8], this.av_fld[var8], this.az_fld[var6]);
			int var10 = this.av_fld[var6];
			int var11 = var4 - var9;
			...
			if (0 != var10) {
				...
				if (var10 >= var13) {
					this.av_fld[var6] = var11 > var9 ? var9 + (var10 - var9) : var9 - var10 + var11 - 1;
				} else {
					this.av_fld[var6] = 0 != (var10 & 1) ? var9 - (var10 + 1) / 2 : var9 + var10 / 2;
				}
			} else {
				this.ae_fld[var6] = false;
				this.av_fld[var6] = var9;
			}
		}

		this.az(0, var3 - 1);
		int var16 = 0;
		int var17 = this.av_fld[0] * this.ak_fld.av_fld;

		for (int var18 = 1; var18 < var3; var18++) {
			if (this.ae_fld[var18]) {
				int var20 = this.az_fld[var18];
				int var22 = this.ak_fld.av_fld * this.av_fld[var18];
				this.ak_fld.av(var16, var17, var20, var22, var1, var2);
				if (var20 >= var2) {
					return;
				}
	...
	void ar(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = this.az_fld[var1];
			int var5 = this.av_fld[var1];
			boolean var6 = this.ae_fld[var1];

			for (int var7 = 1 + var1; var7 <= var2; var7++) {
				int var8 = this.az_fld[var7];
				if (var8 < var4) {
					this.az_fld[var3] = var8;
					this.av_fld[var3] = this.av_fld[var7];
	...
	void ak(float[] var1, int var2) {
		...
		for (int var7 = 2; var7 < var4; var7++) {
			int var8 = au.qq(this.ak_fld, this.az_fld, var7);
			int var9 = this.ak_fld.ag(this.az_fld, var7);
			int var10 = this.ak_fld.al(this.az_fld[var8], this.av_fld[var8], this.az_fld[var9], this.av_fld[var9], this.az_fld[var7]);
			int var11 = this.av_fld[var7];
			...
			if (0 != var11) {
				...
				if (var11 >= var14) {
					this.av_fld[var7] = var12 > var10 ? var10 + (var11 - var10) : var10 - var11 + var12 - 1;
				} else {
					this.av_fld[var7] = 0 != (var11 & 1) ? var10 - (var11 + 1) / 2 : var10 + var11 / 2;
				}
			} else {
				this.ae_fld[var7] = false;
				this.av_fld[var7] = var10;
			}
		}

		this.az(0, var4 - 1);
		int var17 = 0;
		int var18 = this.av_fld[0] * this.ak_fld.av_fld;

		for (int var19 = 1; var19 < var4; var19++) {
			if (this.ae_fld[var19]) {
				int var21 = this.az_fld[var19];
				int var23 = this.ak_fld.av_fld * this.av_fld[var19];
				this.ak_fld.av(var17, var18, var21, var23, var1, var2);
				if (var21 >= var2) {
					return;
				}
