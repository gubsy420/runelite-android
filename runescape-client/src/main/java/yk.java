...
public class yk {
	...
	public static void dj(cl var0) {
		if (var0 == null) {
			var0.getClass();
		}

		for (int var1 = 0; var1 < var0.ak_fld.size(); var1++) {
			((da)var0.ak_fld.get(var1)).er(var0.as_fld, 1558641038);
		}
	}
	...
	public static int ww(dx var0, fa var1, int var2, int var3, int var4, int var5, int var6) {
		if (var0 == null) {
			throw new NullPointerException();
		} else if (var1.ah_fld) {
			return var0.af_fld[var6][var2][var3];
		} else {
			mn.ak(0, var0.af_fld, var6, var2, var3, dx.ao_fld[0], dx.ab_fld[0], dx.ap_fld[0]);
			mn.ak(1, var0.af_fld, var6, var2, var3, dx.ao_fld[1], dx.ab_fld[1], dx.ap_fld[1]);

			for (int var7 = 0; var7 < 2; var7++) {
				int var8 = dx.ao_fld[var7][0];
				int var9 = dx.ap_fld[var7][0];
				int var10 = dx.ao_fld[var7][1];
				int var11 = dx.ap_fld[var7][1];
				int var12 = dx.ao_fld[var7][2];
				int var13 = dx.ap_fld[var7][2];
				if (ev.af(var4, var5, var9, var11, var13, var8, var10, var12)) {
					int var14 = dx.ab_fld[var7][0];
					int var15 = dx.ab_fld[var7][1];
					int var16 = dx.ab_fld[var7][2];
	...
	public static void sx(yk var0) {
		if (var0 == null) {
			var0.getClass();
		} else {
			var0.ay_fld = var0.ay_fld + (var0.as_fld += 1123671526) * 326493940;

			for (int var1 = 0; var1 < 256; var1++) {
				int var2 = var0.ah_fld[var1];
				if ((var1 & 2) == 0) {
					if (0 == (var1 & 1)) {
						var0.aw_fld = var0.aw_fld ^ var0.aw_fld << 13;
					} else {
						var0.aw_fld = -1428320371 * (var0.aw_fld ^ var0.aw_fld >>> 6);
					}
				} else if (0 == (var1 & 1)) {
					var0.aw_fld = -1793004517 * (var0.aw_fld ^ var0.aw_fld << 2);
				} else {
					var0.aw_fld = var0.aw_fld ^ var0.aw_fld >>> 16;
				}

				var0.aw_fld = var0.aw_fld + 1887034490 * var0.ah_fld[var1 + 128 & 1223533063];
				int var3;
				var0.ah_fld[var1] = var3 = var0.ay_fld + var0.aw_fld + var0.ah_fld[(var2 & 1144388632) >> 2];
				var0.ae_fld[var1] = (var0.ay_fld = (var0.ah_fld[(var3 >> 8 & -246360387) >> 2] + var2) * 599389641) * -1933691783;
			}
		}
	}
	...
	public static void sv(yk var0, byte var1) {
		if (var0 == null) {
			var0.getClass();
		} else {
			var0.ay_fld = var0.ay_fld + (var0.as_fld += 1645502445) * -1126753843;

			for (int var2 = 0; var2 < 256; var2++) {
				int var3 = var0.ah_fld[var2];
				if ((var2 & 2) == 0) {
					if (var1 == 1) {
						return;
					}
					...
					var0.aw_fld = -1428320371 * (var0.aw_fld ^ var0.aw_fld << 2);
				} else {
					var0.aw_fld = var0.aw_fld ^ var0.aw_fld >>> 16;
				}

				var0.aw_fld = var0.aw_fld + -1428320371 * var0.ah_fld[var2 + 128 & 0xFF];
				int var4;
				var0.ah_fld[var2] = var4 = var0.ay_fld + var0.aw_fld + var0.ah_fld[(var3 & 1020) >> 2];
				var0.ae_fld[var2] = (var0.ay_fld = (var0.ah_fld[(var4 >> 8 & 1020) >> 2] + var3) * 599389641) * -1933691783;
			}
		}
	}
	...
	final void az(byte var1) {
		this.as_fld = this.ay_fld + (this.as_fld += 1645502445) * -1126753843;
		...
		for (int var2 = 0; var2 < 256; var2++) {
			...
			if ((var2 & 2) == 0) {
				...
				if (0 == (var2 & 1)) {
					this.ay_fld = this.ay_fld ^ this.as_fld << 13;
				} else {
					this.ay_fld = -1428320371 * (this.as_fld ^ this.av_fld >>> 6);
				}
			} else if (0 == (var2 & 1)) {
				this.av_fld = -1428320371 * (this.ay_fld ^ this.av_fld << 2);
			} else {
				this.as_fld = this.av_fld ^ this.av_fld >>> 16;
			}

			this.ay_fld = this.aw_fld + -1428320371 * this.ae_fld[var2 + 128 & 0xFF];
			int var4;
			this.ah_fld[var2] = var4 = this.aw_fld + this.ay_fld + this.ah_fld[(var3 & 1020) >> 2];
			this.ae_fld[var2] = (this.as_fld = (this.ah_fld[(var4 >> 8 & 1020) >> 2] + var3) * 599389641) * -1933691783;
		}
	}
}
