...
public class bg extends vw implements ItemContainer {
	...
	public static boolean sj(sc var0, int var1) {
		if (var0 == null) {
			var0.getClass();
		}

		return sc.de(var0, var1) && (var0.aw_fld[var1] == 2 || 3 == var0.aw_fld[var1]);
	}
	...
	static void dg(dx var0, int var1, int var2, int var3, int var4, int var5, int var6) throws EOFException {
		try {
			...
			if (null != var8) {
				for (dw var9 = (dw)var8.aw(); var9 != null; var9 = (dw)var8.as()) {
					if (var9.ag_fld == var4 && var5 == var9.az_fld) {
						int var10001 = var6 * -1329750057;
						var9.iq(var6 * -1329750057 * -1736653849);
						var9.az_fld = var10001;
						break;
					}
				}
