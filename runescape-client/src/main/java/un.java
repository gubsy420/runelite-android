...
public class un {
	...
	public byte[] av(int var1) throws EOFException {
		synchronized (this.ag_fld) {
			byte[] var21;
			try {
				if (this.az_fld.az() < var1 * 6 + 6) {
					return null;
				}

				this.az_fld.af(var1 * 6);
				this.az_fld.ah(ak_fld, 0, 6, 1535799479);
				...
				if (var4 <= 0 || var4 > this.ag_fld.az() / 520L) {
					return null;
				}
				...
				while (var6 < var3) {
					...
					if (var1 > 65535) {
						...
						var13 = 10;
						this.ag_fld.ah(ak_fld, 0, var8 + var13, 1535799479);
					...
					if (var1 == var9 && var10 == var7 && this.av_fld == var12) {
						if (var11 >= 0 && var11 <= this.ag_fld.az() / 520L) {
	...
	boolean as(int var1, byte[] var2, int var3, boolean var4) throws EOFException {
		synchronized (this.ag_fld) {
			boolean var20;
			try {
				int var6;
				if (var4) {
					...
					if (var6 <= 0 || var6 > this.ag_fld.az() / 520L) {
						return false;
					}
				} else {
					zu.pj(this.ag_fld, 1576979688);
				...
				for (int var9 = var6; var7 < var3; var8++) {
					...
					if (var4) {
						...
						int var13;
						if (var1 > 65535) {
							this.ag_fld.ah(ak_fld, 0, 10, 1535799479);
							...
							this.ag_fld.ah(ak_fld, 0, 8, 1535799479);
						...
						if (var10 < 0 || var10 > this.ag_fld.az() / 520L) {
							return false;
						}
					}
					...
					if (var1 > 65535) {
						...
						this.ag_fld.ay(ak_fld, 0, 10, 1545139139);
						int var17 = var3 - var7;
						if (var17 > 510) {
							var17 = 510;
						}

						this.ag_fld.ay(var2, var7, var17, 1579251958);
						var7 += var17;
					} else {
						if (var3 - var7 <= 512) {
							var10 = 0;
						...
						this.ag_fld.af(var9 * 520L);
						this.ag_fld.ay(ak_fld, 0, 8, 1836568985);
						int var18 = var3 - var7;
						if (var18 > 512) {
							var18 = 512;
						}

						this.ag_fld.ay(var2, var7, var18, 2046179440);
						var7 += var18;
					}
				...
				ak_fld[5] = (byte)var6;
				this.az_fld.af(var1 * 6);
				this.az_fld.ay(ak_fld, 0, 6, 1640390200);
				var20 = true;
		...
		synchronized (this.ag_fld) {
			...
			try {
				...
				if (var4) {
					...
					if (var7 <= 0 || var7 > this.ag_fld.az() / 520L) {
						return false;
					}
				} else {
					zu.pj(this.ag_fld, 1576979688);
	...
	public static void sp(da var0) {
		var0.cg_fld.az_fld = false;
		var0.cg_fld.af_fld = 622748315;
	}
	...
	public static byte[] mz(un var0, int var1, byte var2) throws EOFException {
		if (var0 == null) {
				...
				try {
					...
					while (var7 < var4) {
						...
						if (var1 > 65535) {
							...
							var14 = 10;
							var0.ag_fld.ah(ak_fld, 0, var9 + var14, 1535799479);
						...
						if (var1 == var10 && var11 == var8 && var0.av_fld == var13) {
							if (var12 >= 0 && var12 <= var0.ag_fld.az() / 520L) {
	...
	static final void ax(dx var0, int var1, int var2, int var3, int var4, int var5, int var6, gn var7) throws EOFException {
		...
		var16 += var10.qr_fld;
		var17 += var10.qr_fld;
		int var18 = var2 + var10.qr_fld;
		int var19 = var3 + var10.qr_fld;
		boolean var20 = var2 > 0 && var2 < 103 && var3 > 0 && var3 < 103;
		int[][] var21 = var9.ro_fld[var1];
		...
		long var26 = client.np(var1, var2, var3, 2, !var25, var4, var0.ag_fld);
		...
		if (var11.cq()) {
			client.gn(var9, var1, var2, var3, var11, var5);
		}
		...
		if (var6 == 22) {
			...
			if (!var29) {
				...
				int var30 = var10.fl_fld[var1][var18][var19] & 32767;
				if (var30 > 0) {
					ov var31 = var9.kx(var30 - 1);
					if (var31.wj() < 0 && var31.qs() == 16711935) {
						var29 = true;
					}
				}
			}
			...
			if (var29) {
				...
				if (var11.dc_fld == -1 && var11.dy_fld == null) {
					var54 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
				} else {
				...
				var10.ni(var1, var2, var3, var22, (em)var54, var26, var28);
			...
			Object var40;
			if (var11.dc_fld == -1 && var11.dy_fld == null) {
				var40 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
			} else {
			...
			var10.ut(var1, var2, var3, var22, 1, 1, (em)var40, 0, var26, var28);
			if (var6 <= 17 && var6 != 13 && var1 > 0) {
				var9.fn_fld[var1][var18][var19] = var9.fn_fld[var1][var18][var19] | 2340;
			}

			if (var11.cu_fld != 0 && var7 != null && var20) {
				var7.lv(var2, var3, var12, var13, var11.du_fld);
			}
		} else if (var6 != 10 && var6 != 11) {
			if (var6 == 0) {
				Object var42;
				if (var11.dc_fld == -1 && var11.dy_fld == null) {
					var42 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
				} else {
				...
				var10.be(var1, var2, var3, var22, (em)var42, null, 1 << var5, 0, var26, var28);
				if (var5 == 0) {
					if (var11.dd_fld) {
						var9.ox_fld[var1][var18][var19] = 50;
						var9.ox_fld[var1][var18][var19 + 1] = 50;
					}

					if (var11.cl_fld) {
						var9.fn_fld[var1][var18][var19] = var9.fn_fld[var1][var18][var19] | 585;
					}
				} else if (var5 == 1) {
					if (var11.dd_fld) {
						var9.ox_fld[var1][var18][var19 + 1] = 50;
						var9.ox_fld[var1][var18 + 1][var19 + 1] = 50;
					}

					if (var11.cl_fld) {
						var9.fn_fld[var1][var18][var19 + 1] = var9.fn_fld[var1][var18][var19 + 1] | 1170;
					}
				} else if (var5 == 2) {
					if (var11.dd_fld) {
						var9.ox_fld[var1][var18 + 1][var19] = 50;
						var9.ox_fld[var1][var18 + 1][var19 + 1] = 50;
					}

					if (var11.cl_fld) {
						var9.fn_fld[var1][var18 + 1][var19] = var9.fn_fld[var1][var18 + 1][var19] | 585;
					}
				} else if (var5 == 3) {
					if (var11.dd_fld) {
						var9.ox_fld[var1][var18][var19] = 50;
					...
					if (var11.cl_fld) {
						var9.fn_fld[var1][var18][var19] = var9.fn_fld[var1][var18][var19] | 1170;
					}
				}

				if (var11.cu_fld != 0 && var7 != null && var20) {
					var7.ee(var2, var3, var6, var5, var11.ci_fld);
				}

				if (var11.dh_fld != 16) {
					var10.xo(var1, var2, var3, var11.dh_fld + 1);
				}
				...
				if (var6 == 2) {
					...
					Object var70;
					if (var11.dc_fld == -1 && var11.dy_fld == null) {
						var70 = var11.zp(2, var5 + 4, var21, var23, var22, var24);
						var60 = var11.zp(2, var44, var21, var23, var22, var24);
					} else {
						...
						var75.vc_fld = var33.vc_fld = var10;
						var60 = var75;
						var70 = var33;
					}

					var10.be(var1, var2, var3, var22, (em)var70, (em)var60, 1 << var5, 1 << var44, var26, var28);
					if (var11.cl_fld) {
						if (var5 == 0) {
							var9.fn_fld[var1][var18][var19] = var9.fn_fld[var1][var18][var19] | 585;
							var9.fn_fld[var1][var18][var19 + 1] = var9.fn_fld[var1][var18][var19 + 1] | 1170;
					...
					Object var45;
					if (var11.dc_fld == -1 && var11.dy_fld == null) {
						var45 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
					} else {
					...
					var10.ut(var1, var2, var3, var22, 1, 1, (em)var45, 0, var26, var28);
					if (var11.cu_fld != 0 && var7 != null && var20) {
						var7.lv(var2, var3, var12, var13, var11.ci_fld);
					}

					if (var11.dh_fld != 16) {
						var10.xo(var1, var2, var3, var11.dh_fld / 2 + 1);
					}
				} else if (var6 == 4) {
					Object var46;
					if (var11.dc_fld == -1 && var11.dy_fld == null) {
						var46 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
					} else {
					...
					var10.jl(var1, var2, var3, var22, (em)var46, null, 1 << var5, 0, dt.ah_fld[var5], dt.aw_fld[var5], 0, 0, var26, var28);
				} else if (var6 == 5) {
					int var47 = 16;
					fs var63 = var10.xa(var1, var2, var3);
					if (var63 != null) {
						var47 = oe.ep(var63.getId()).dh_fld * -1071654907;
					}

					var47++;
					Object var71;
					if (var11.dc_fld == -1 && var11.dy_fld == null) {
						var71 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, 4, var5, var1, var2, var3, var23, var22, var24);
					} else {
					...
					var10.jl(var1, var2, var3, var22, (em)var71, null, 1 << var5, 0, var47 * dt.ah_fld[var5], var47 * dt.aw_fld[var5], 0, 0, var26, var28);
				} else if (var6 == 6) {
					int var49 = 8;
					fj var64 = var10.gc(var1, var2, var3);
					if (var64 != null) {
						var49 = oe.ep(var64.getId()).dh_fld * -1071654907 / 2;
					}

					var49++;
					Object var72;
					if (var11.dc_fld == -1 && var11.dy_fld == null) {
						var72 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, 4, var5 + 4, var1, var2, var3, var23, var22, var24);
					} else {
					...
					var10.jl(var1, var2, var3, var22, (em)var72, null, 256, var5, var49 * dt.ay_fld[var5], var49 * dt.as_fld[var5], 0, 0, var26, var28);
				} else if (var6 == 7) {
					int var51 = var5 + 2 & 3;
					Object var65;
					if (var11.dc_fld == -1 && var11.dy_fld == null) {
						var65 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, 4, var51 + 4, var1, var2, var3, var23, var22, var24);
					} else {
					...
					var10.jl(var1, var2, var3, var22, (em)var65, null, 256, var51, dt.ay_fld[var51], dt.as_fld[var51], 0, 0, var26, var28);
				} else if (var6 == 8) {
					int var52 = 8;
					fj var66 = var10.gc(var1, var2, var3);
					if (var66 != null) {
						var52 = oe.ep(var66.getId()).dh_fld * -1071654907 / 2;
					}
					...
					Object var79;
					if (var11.dc_fld == -1 && var11.dy_fld == null) {
						var78 = var11.zp(4, var5 + 4, var21, var23, var22, var24);
						var79 = var11.zp(4, var74 + 4, var21, var23, var22, var24);
					} else {
						...
						var34.vc_fld = var35.vc_fld = var10;
						var78 = var34;
						var79 = var35;
					}
				...
				Object var43;
				if (var11.dc_fld == -1 && var11.dy_fld == null) {
					var43 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
				} else {
				...
				var10.be(var1, var2, var3, var22, (em)var43, null, 16 << var5, 0, var26, var28);
				if (var11.dd_fld) {
					if (var5 == 0) {
						var9.ox_fld[var1][var18][var19 + 1] = 50;
					} else if (var5 == 1) {
			...
			Object var41;
			if (var11.dc_fld == -1 && var11.dy_fld == null) {
				var41 = client.uu(var0.az_fld, var10, var11, var21, var6, var5, 10, var5, var1, var2, var3, var23, var22, var24);
			} else {
			...
			if (var41 != null && var10.ut(var1, var2, var3, var22, var12, var13, (em)var41, var6 == 11 ? 256 : 0, var26, var28) && var11.dd_fld) {
				int var57 = 15;
				...
				for (int var69 = 0; var69 <= var12; var69++) {
					for (int var32 = 0; var32 <= var13; var32++) {
						if (var57 > var9.ox_fld[var1][var69 + var18][var32 + var19]) {
							var9.ox_fld[var1][var69 + var18][var32 + var19] = (byte)var57;
						}
					}
				}
			}
	...
	public static boolean to(pd var0, Object var1) {
		if (var0 == null) {
			throw new NullPointerException();
		} else {
			return var0.az_fld.containsKey(var1);
		}
	}
	...
	public byte[] ak(int var1, byte var2) throws EOFException {
		synchronized (this.ag_fld) {
			byte[] var22;
			try {
				if (this.az_fld.az() < var1 * 6 + 6) {
				...
				if (var5 <= 0 || var5 > this.az_fld.az() / 520L) {
					return null;
				}
				...
				while (var7 < var4) {
					...
					if (var1 > 65535) {
						...
						var14 = 10;
						this.az_fld.ah(ak_fld, 0, var9 + var14, 1535799479);
						var10 = ((ak_fld[2] & 255) << 8) + ((ak_fld[0] & 255) << 24) + ((ak_fld[1] & 255) << 16) + (ak_fld[3] & 255);
						var11 = (ak_fld[5] & 255) + ((ak_fld[4] & 255) << 8);
						var12 = (ak_fld[8] & 255) + ((ak_fld[6] & 255) << 16) + ((ak_fld[7] & 255) << 8);
						var13 = ak_fld[9] & 255;
						...
						var14 = 8;
						this.ag_fld.ay(ak_fld, 0, var9 + var14, 1535799479);
						var10 = ((ak_fld[0] & 255) << 8) + (ak_fld[1] & 255);
						var11 = ((ak_fld[2] & 255) << 8) + (ak_fld[3] & 255);
						var12 = (ak_fld[6] & 255) + ((ak_fld[5] & 255) << 8) + ((ak_fld[4] & 255) << 16);
						var13 = ak_fld[7] & 255;
					...
					if (var1 == var10 && var11 == var8 && this.av_fld == var13) {
						if (var12 >= 0 && var12 <= this.ag_fld.az() / 520L) {
							int var15 = var14 + var9;
