...
public class pl extends vc {
	...
	public void qs(xi var1, int var2) {
		this.av(var1, var2);
	}
	...
	void ae(xi var1, int var2, int var3, int var4) {
		if (1 == var2) {
			...
			this.az_fld = xi.lx(var1, -391391847);
		}
	}
	...
	void aq(xi var1, int var2) {
		if (1 == var2) {
			this.az_fld = xi.lx(var1, -608862813);
		}
	}
