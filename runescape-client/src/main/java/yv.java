...
public class yv extends yu implements SpritePixels {
	...
	public void bu(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
		this.be(var1, var2, var3, var4, var5, var6, var7, var9);
	}
	...
	public static void ue(yv var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var0 == null) {
			var0.getClass();
		} else if (var6 != 0) {
			var1 -= var0.as_fld << 4;
	...
	public static void xx(yv var0, int var1, int var2, int var3, int var4) {
		if (var0 == null) {
			var0.getClass();
		}
		...
		if (var3 == 766276948) {
			...
			if (var8 > 0 && var7 > 0) {
				av(al_fld, var0.ah_fld, 0, var6, var5, var8, var7, var9, var10, var3, var4);
			}
		}
	}
	...
	public void io(int var1, int var2, int var3, int var4) {
		this.ic(this.ad_fld << 3, this.ao_fld << 3, var1 << 4, var2 << 4, var3, var4);
	}
	...
	public static void zy(yv var0, int var1, int var2, int var3, int var4, int var5) {
		if (var0 == null) {
			var0.getClass();
		}
		...
		if (var3 > 0 && var4 > 0) {
			...
			if (var5 == -369194137) {
				as(0, 0, 0, var8, var0.ah_fld, al_fld, 0, 0, -var4, var9, var18, var15, var3, var12, var13, var6);
			} else {
				ar(0, 0, 0, var8, var0.ah_fld, al_fld, 0, 0, -var4, var9, var18, var15, var3, var12, var13, var6, var5);
			}
		}
	}
	...
	public static void zv(yv var0, int var1, int var2) {
		var1 += var0.as_fld;
		var2 += var0.ar_fld;
		int var3 = var1 + var2 * au_fld;
		int var4 = 0;
	...
	public void dm(int var1, int var2) {
		var1 += this.as_fld;
		var2 += this.ar_fld;
		int var3 = var1 + var2 * au_fld;
		int var4 = 0;
	...
	public static void qi(yv var0, int var1, int var2, int var3) {
		var1 += var0.as_fld;
		var2 += var0.ar_fld;
		int var4 = var1 + var2 * au_fld;
		int var5 = 0;
		...
		if (var7 > 0 && var6 > 0) {
			if (var3 == 1745725310) {
				aw(0, 0, 0, al_fld, var0.ah_fld, var5, 0, var4, 0, var7, var6, var8, var9);
			} else {
				ay(0, 0, 0, al_fld, var0.ah_fld, var5, 0, var4, 0, var7, var6, var8, var9, var3);
			}
		}
	}
	...
	void ic(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) {
			var1 -= this.as_fld << 4;
			var2 -= this.ar_fld << 4;
			double var7 = (var5 & 65535) * 9.587379924285257E-5;
	...
	public static void ly(yv var0, int var1, int var2, int var3, int var4, int var5) {
		if (var0 == null) {
			var0.getClass();
		}
	...
	public static void aj(yv var0, int var1, int var2) {
		if (var0 == null) {
			var0.getClass();
		}
		...
		if (var6 > 0 && var5 > 0) {
			ag(al_fld, var0.ah_fld, 0, var4, var3, var6, var5, var7, var8);
		}
	}
	...
	public void vi(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int[] var11, int[] var12) {
	...
	public void ia(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
		try {
			if (var7 < Math.PI / 2 || var7 > Math.PI * 3.0 / 2.0) {
				if (au_fld % 2 != 0) {
					var5++;
	...
	public static void rd(yv var0, int var1, int var2, int var3, int var4) {
		if (var3 <= var0.ad_fld && var4 <= var0.ao_fld) {
	...
	void iy(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) {
			var1 -= this.as_fld << 4;
			var2 -= this.ar_fld << 4;
			double var7 = (var5 & 65535) * 9.587379924285257E-5;
	...
	public yv au() {
		yv var1 = new yv(this.ao_fld, this.ao_fld);

		for (int var2 = 0; var2 < this.aw_fld; var2++) {
			for (int var3 = 0; var3 < this.ad_fld; var3++) {
				var1.ah_fld[(var2 + this.ar_fld) * this.ao_fld + var3 + this.as_fld] = this.ah_fld[var2 * this.ao_fld + var3];
			}
		}
	...
	public void ac(int var1, int var2, int var3) {
		var1 += this.ad_fld;
		var2 += this.ar_fld;
		int var4 = var1 + var2 * yu.am_fld;
		int var5 = 0;
		int var6 = this.as_fld;
		int var7 = this.as_fld;
		int var8 = au_fld - var7;
		int var9 = 0;
		if (var2 < yu.ai_fld) {
			int var10 = yu.aq_fld - var2;
			var6 -= var10;
			var2 = yu.ai_fld;
			var5 += var10 * var7;
			var4 += var10 * yu.ai_fld;
		}

		if (var2 + var6 > yu.am_fld) {
			var6 -= var2 + var6 - yu.am_fld;
		}
		...
		if (var1 + var7 > yu.ai_fld) {
			int var14 = var1 + var7 - yu.ai_fld;
			var7 -= var14;
			var9 += var14;
			var8 += var14;
		}
		...
		if (var7 > 0 && var6 > 0) {
			if (var3 == -799534340) {
				bn(0, 0, 0, al_fld, this.ah_fld, var5, 0, var4, 0, var7, var6, var8, var9);
			} else {
				bq(0, 0, 0, al_fld, this.ah_fld, var5, 0, var4, 0, var7, var6, var8, var9, var3);
			}
		}
	}
	...
	public void aj(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			...
			int var13 = (var11 << 16) / var4;
			if (this.ao_fld > 0) {
				int var14 = ((this.aw_fld << 16) + var12 - 1) / var12;
				var1 += var14;
				var8 += var14 * var12 - (this.ay_fld << 16);
			}
			...
			int var18 = var1 + var2 * yu.aq_fld;
			int var15 = yu.aa_fld - var3;
			if (var2 + var4 > yu.ax_fld) {
				var4 -= var2 + var4 - yu.au_fld;
			}

			if (var2 < aa_fld) {
				int var16 = yu.ai_fld - var2;
				var4 -= var16;
				var18 += var16 * yu.aa_fld;
				var9 += var13 * var16;
			}

			if (var1 + var3 > yu.ai_fld) {
				int var19 = var1 + var3 - yu.ax_fld;
				var3 -= var19;
				var15 += var19;
			}

			if (var1 < aq_fld) {
				int var20 = yu.aa_fld - var1;
				var3 -= var20;
				var18 += var20;
				var8 += var12 * var20;
				var15 += var20;
	...
	public void rq(int var1, int var2) {
		var1 += this.ao_fld;
		var2 += this.ar_fld;
		int var3 = var1 + var2 * yu.ai_fld;
		int var4 = 0;
		int var5 = this.aw_fld;
		int var6 = this.as_fld;
		int var7 = yu.am_fld - var6;
		int var8 = 0;
		if (var2 < yu.ax_fld) {
			int var9 = yu.au_fld - var2;
			var5 -= var9;
			var2 = yu.aq_fld;
			var4 += var9 * var6;
			var3 += var9 * yu.ai_fld;
		...
		if (var2 + var5 > yu.ax_fld) {
			var5 -= var2 + var5 - yu.aa_fld;
		}

		if (var1 < yu.ai_fld) {
			int var12 = yu.ai_fld - var1;
			var6 -= var12;
			var1 = yu.ax_fld;
			var4 += var12;
			var3 += var12;
		...
		if (var1 + var6 > yu.aq_fld) {
			int var13 = var1 + var6 - yu.au_fld;
			var6 -= var13;
			var8 += var13;
			var7 += var13;
		}
		...
		if (var6 > 0 && var5 > 0) {
			bj(al_fld, this.ah_fld, var4, var3, var6, var5, var7, var8);
		}
	}
}
