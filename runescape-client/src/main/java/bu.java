...
public class bu {
	...
	public static void he(int var0, int var1, int var2, boolean var3) {
		jm var5 = gi.ak(jb.ae_fld, client.appletStub.av_fld);
		var5.ay_fld.cx(var2);
		var5.ay_fld.et(var3 ? client.mq_fld : 0);
		var5.ay_fld.ca(var1);
		var5.ay_fld.ba(var0);
	...
	static yo hv(int var0) throws EOFException {
		yo var2 = (yo)client.kp_iw.ak(var0);
		if (var2 == null) {
	...
	static final void cm(dx var0, or var1, int var2) throws EOFException {
		for (int var3 = 0; var3 < var0.am_fld.az(); var3++) {
			ds var4 = (ds)var0.ax_fld.ae(yw.wk(var0.am_fld, var3, (byte)12));
			if (null != var4) {
				if (var2 >= 1003509737) {
					return;
				}
				...
				if (var4.bm(1646425248)) {
					...
					if (var4.ah_fld.ek_fld == var1) {
						...
						if (var4.ah_fld.an(-1019607204)) {
							...
							int var6 = kj.ay(var4.bi_fld);
							int var7 = kj.ay(var4.dm_fld);
							if (var0.ae(var6, var7, 1853908949)) {
								if (1 == var4.bn_fld && (var4.bi_fld & 127) == 64) {
									if (var2 >= 1003509737) {
										return;
									}

									if ((var4.dm_fld & 127) == 64) {
								...
								long var8 = dt.ay(0, 0, 0, 1, !var4.ah_fld.df_fld, var4.bq_fld, var0.ag_fld);
								var4.cn_fld = client.dv_fld;
								int var10 = gl.dt(var0, var4.bi_fld, var4.dm_fld, var5, var4.br((byte)49));
								int var11 = var4.bn_fld - 64 + 60;
								boolean var12 = mp.co(var4);
								var4.au_fld = var12;
								boolean var13 = var0.az_fld.bj(var5, var4.bi_fld, var4.dm_fld, var10, var11, var4, var4.bc_fld, var8, var4.an_fld);
								if (var13 && var4.da_fld != 0) {
									...
									for (rq var14 = (rq)client.du_fld.az(); null != var14; var14 = (rq)(rq)client.du_fld.next()) {
										...
										if (client.dv_fld < var14.ak_fld) {
											if (var2 >= 1003509737) {
												return;
											}
										} else {
											long var15 = rq.ob(var14, (byte)-21) ? var8 : -1L;
											var0.az_fld.bl(var5, var4.bi_fld, var4.dm_fld, var10, var14, var4.bc_fld, var15);
										}
									}
								}
							}
