...
public class dp extends de {
	...
	@ObfuscatedName("bm")
	@ObfuscatedSignature(
		descriptor = "(Ldj;I)Ljava/net/URLConnection;"
	)
			...
			label126: {
				try {
					label131: {
						...
						de.bt(this, var3, var1, (short)-12956);
						var10 = false;
						break label135;
					}
	...
	@ObfuscatedName("oa")
	@ObfuscatedSignature(
		descriptor = "(Ldp;Ldj;)Ljava/net/URLConnection;"
	)
	public static URLConnection oa(dp var0, dj var1) throws IOException {
		if (var0 == null) {
			throw new NullPointerException();
		} else {
			URLConnection var2 = var1.az_fld.openConnection();
			var0.aw(var2, 958190300);
			return var2;
		}
	}
	...
	void al(dj var1) throws IOException {
		...
		try {
			try {
				...
				de.bt(this, var2, var1, (short)-19016);
	...
	void au(dj var1) throws IOException {
		...
		try {
			try {
				...
				de.bt(this, var2, var1, (short)-16071);
			} catch (IOException var9) {
	...
	@ObfuscatedName("bd")
	@ObfuscatedSignature(
		descriptor = "(Ldj;B)Ljava/net/URLConnection;"
	)
	...
	void af(dj var1) throws IOException {
		...
		try {
			try {
				...
				de.bt(this, var2, var1, (short)-21610);
			} catch (IOException var9) {
				var1.av_fld = dj.ag_fld;
			}
		} finally {
	...
	public static void ak(xi var0, gu var1, int var2, int var3) {
		...
		if (var5 != 0) {
			...
			gu.xn(var1, var6, var7, var8, var9);
		}
	}
			...
			if (bn.dq_fld) {
				if (var3 != -776631127) {
					...
					if (null != gx.dr_fld) {
						...
						gx.dr_fld[1].ae(140 + bn.bo_fld, 1);
						zv.uz(var1, kh.mx_fld, 152 + bn.bo_fld, 10, 16777215, -1);
						gx.dr_fld[0].ae(bn.bo_fld + 140, 12);
						zv.uz(var1, kh.mj_fld, bn.bo_fld + 152, 21, 16777215, -1);
					}
					...
					if (null != hk.dl_fld) {
						...
						label863: {
							...
							if (0 == ct.as_fld[0]) {
								...
								if (ct.ay_fld[0] == 0) {
									hk.dl_fld[2].ae(var113, 4);
									break label863;
								}
							}

							hk.dl_fld[0].ae(var113, 4);
						}

						if (ct.as_fld[0] == 0 && 1 == ct.ay_fld[0]) {
							hk.dl_fld[3].ae(var113 + 15, 4);
						} else {
							hk.dl_fld[1].ae(15 + var113, 4);
						}

						zv.uz(var0, kh.mr_fld, 32 + var113, 17, 16777215, -1);
						int var149 = 390 + bn.bo_fld;
						if (1 == ct.as_fld[0] && 0 == ct.ay_fld[0]) {
							hk.dl_fld[2].ae(var149, 4);
						} else {
							hk.dl_fld[0].ae(var149, 4);
						}

						if (ct.as_fld[0] == 1 && 1 == ct.ay_fld[0]) {
							hk.dl_fld[3].ae(var149 + 15, 4);
						} else {
							hk.dl_fld[1].ae(15 + var149, 4);
						}

						label842: {
							zv.uz(var0, kh.mo_fld, 32 + var149, 17, 16777215, -1);
							...
							if (2 == ct.as_fld[0]) {
								...
								if (ct.ay_fld[0] == 0) {
									hk.dl_fld[2].ae(var174, 4);
									break label842;
								}
							}

							hk.dl_fld[0].ae(var174, 4);
						}

						if (ct.as_fld[0] == 2 && 1 == ct.ay_fld[0]) {
							hk.dl_fld[3].ae(var174 + 15, 4);
						} else {
							hk.dl_fld[1].ae(var174 + 15, 4);
						}

						zv.uz(var0, kh.mu_fld, 32 + var174, 17, 16777215, -1);
						int var186 = 610 + bn.bo_fld;
						if (ct.as_fld[0] == 3 && ct.ay_fld[0] == 0) {
							hk.dl_fld[2].ae(var186, 4);
						} else {
							hk.dl_fld[0].ae(var186, 4);
						}

						if (3 == ct.as_fld[0] && 1 == ct.ay_fld[0]) {
							hk.dl_fld[3].ae(var186 + 15, 4);
						} else {
							hk.dl_fld[1].ae(15 + var186, 4);
						}

						zv.uz(var0, kh.mf_fld, 32 + var186, 17, 16777215, -1);
					}
					...
					if (null != ui.do_fld) {
						...
						for (int var18 = var187 * var17; var18 < ct.ah_fld; var18++) {
							...
							boolean var20 = true;
							String var21 = Integer.toString(var19.af_fld);
							if (-1 == var19.af_fld) {
								var21 = kh.mb_fld;
								var20 = false;
							} else if (var19.af_fld > 1980) {
								var21 = kh.ms_fld;
								var20 = false;
							}
							...
							label799: {
								if (tj.ae_fld >= var14) {
									...
									if (tj.ah_fld >= var215 && tj.ae_fld < var114 + var14 && tj.ah_fld < var150 + var215 && var20) {
										bn.ds_fld = var18;
										ui.do_fld[var22.ai_fld].bk(var14, var215, 128, 16777215);
										var16 = true;
										break label799;
									}
								}

								ui.do_fld[var22.ai_fld].dq(var14, var215);
							}

							if (bt.dd_fld != null) {
								bt.dd_fld[(var19.as((short)2048) ? bt.dd_fld.length / 2 : 0) + var19.ai_fld].ae(var14 + 29, var215);
							}

							var0.ap(Integer.toString(var19.aa_fld), var14 + 15, 5 + var150 / 2 + var215, var23, -1);
						...
						if (var16) {
							...
							int var216 = var1.an(yd.ae_fld[bn.ds_fld].ax_fld) + 6;
							...
							var1.ap(yd.ae_fld[bn.ds_fld].ax_fld, tj.ae_fld, 4 + var1.ap_fld + var218, 0, -1);
						}
					}
				}
			} else {
				...
				if (20 == client.cl_fld) {
					nn.cf_fld.ae(180 + bn.ck_fld - nn.cf_fld.az_fld / 2, 271 - nn.cf_fld.av_fld / 2);
					short var26 = 201;
					...
					if (4 != bn.co_fld && bn.co_fld != 10 && 1 != bn.co_fld) {
						zv.uz(var0, kh.ju_fld, bn.ck_fld + 180 - 110, var27, 16777215, 0);
						short var115 = 200;
						...
						zv.uz(var0, zv.ay(var6), 180 + bn.ck_fld - 70, var27, 16777215, 0);
						var27 += 15;
						...
						zv.uz(var0, kh.ji_fld + var9, bn.ck_fld + 180 - 108, var27, 16777215, 0);
						var27 += 15;
					}
				}
				...
				label932: {
					...
					if (0 == bn.co_fld) {
						...
						short var151 = 291;
						qv.cx_fld.ae(var116 - 73, var151 - 20);
						...
						short var152 = 321;
						qv.cx_fld.ae(var118 - 73, var152 - 20);
						...
						var40 += 15;
						var40 += 7;
						zv.uz(var0, kh.ju_fld, bh.cb_fld - 110, var40, 16777215, 0);
						short var120 = 200;
						String var153 = ci.ae();
						...
						zv.uz(var0, var10001.append(var10002 & var10003 ? gd.ag(16776960, -1940547058) + db.az_fld : "").toString(), bh.cb_fld - 108, var40, 16777215, 0);
						var40 += 15;
						short var46 = 277;
						int var10 = -117 + bh.cb_fld;
						yc var11 = gh.av(client.dq_fld, bn.dh_fld);
						var11.ae(var10, var46);
						var10 += 5 + var11.az_fld;
						zv.uz(var1, kh.ka_fld, var10, 13 + var46, 16776960, 0);
						var10 = 24 + bh.cb_fld;
						var11 = gh.av(cx.kq_fld.bl(1120832785), bn.dv_fld);
						var11.ae(var10, var46);
						var10 += 5 + var11.az_fld;
						zv.uz(var1, kh.kt_fld, var10, var46 + 13, 16776960, 0);
						int var47 = var46 + 15;
						int var12 = bh.cb_fld - 80;
						short var13 = 321;
						qv.cx_fld.ae(var12 - 73, var13 - 20);
						...
						short var154 = 276;
						qv.cx_fld.ae(var121 - 73, var154 - 20);
						...
						zv.uz(var0, var156 + var177 + (client.dv_fld % 40 < 20 ? gd.ag(16776960, -1940547058) + db.az_fld : ""), 180 + bn.ck_fld - 108, var54, 16777215, 0);
						var54 -= 8;
						zv.uz(var0, kh.bm_fld, 180 + bn.ck_fld - 9, var54, 16776960, 0);
						var54 += 15;
						zv.uz(var0, kh.bd_fld, bn.ck_fld + 180 - 9, var54, 16776960, 0);
						...
						var208.ae(var197, var205);
						var54 += 15;
						int var211 = bn.ck_fld + 180 - 80;
						short var214 = 321;
						qv.cx_fld.ae(var211 - 73, var214 - 20);
						...
						var61 += 15;
						var61 += 14;
						zv.uz(var0, kh.kw_fld, bn.ck_fld + 180 - 145, var61, 16777215, 0);
						short var123 = 174;
						String var157 = ci.ae();
						...
						zv.uz(var0, zv.ay(var157) + (client.dv_fld % 40 < 20 ? gd.ag(16776960, -1940547058) + db.az_fld : ""), bn.ck_fld + 180 - 34, var61, 16777215, 0);
						var61 += 15;
						int var178 = 180 + bn.ck_fld - 80;
						short var190 = 321;
						qv.cx_fld.ae(var178 - 73, var190 - 20);
						...
						short var158 = 321;
						qv.cx_fld.ae(var124 - 73, var158 - 20);
						...
						if (fv.dh_fld && !client.gz_fld) {
							...
							for (int var160 = 0; var160 < 8; var160++) {
								...
								var127 += 50;
								zv.uz(var0, zv.ay("/"), var127 - 13, var75 + 27, 16777215, 0);
							}

							int var161 = bh.cb_fld - 80;
							short var181 = 321;
							qv.cx_fld.ae(var161 - 73, var181 - 20);
							...
							short var159 = 321;
							qv.cx_fld.ae(var125 - 73, var159 - 20);
						...
						short var163 = 321;
						qv.cx_fld.ae(var128 - 73, var163 - 20);
						...
						short var164 = 311;
						qv.cx_fld.ae(var130 - 73, var164 - 20);
						...
						vn.cs_fld.ae(var85 - 109, var132);
						if (bn.ct_fld.isEmpty()) {
							ij.cp_fld.ae(var85 - 48, 18 + var132);
						} else {
							ij.cp_fld.ae(var85 - 48, var132 + 5);
						...
						var86 = bh.cb_fld - 80;
						short var137 = 311;
						qv.cx_fld.ae(var86 - 73, var137 - 20);
						...
						short var91 = 311;
						qv.cx_fld.ae(var138 - 73, var91 - 20);
						...
						short var198 = 276;
						qv.cx_fld.ae(var192 - 73, var198 - 20);
						if (1 == bn.bi_fld) {
						...
						short var166 = 301;
						qv.cx_fld.ae(var140 - 73, var166 - 20);
						...
						short var167 = 321;
						qv.cx_fld.ae(var141 - 73, var167 - 20);
						...
						short var168 = 276;
						qv.cx_fld.ae(var143 - 73, var168 - 20);
						...
						short var170 = 276;
						qv.cx_fld.ae(var145 - 73, var170 - 20);
						String var219;
						if (ct.ar_fld != null) {
							if (var3 == -776631127) {
								return;
				...
				if (client.cl_fld >= 10) {
					...
					do_.bp_fld.ae(bn.bo_fld - 22, client.dv_fld);
					do_.bp_fld.ae(22 + bn.bo_fld + 765 - 128, client.dv_fld);
					yu.di(var110);
				}

				jm.ca_fld[cn.mv(cx.kq_fld, (short)27068) ? 1 : 0].ae(bn.bo_fld + 765 - 40, 463);
				if (client.cl_fld > 5) {
					if (var3 == -776631127) {
						return;
					}
